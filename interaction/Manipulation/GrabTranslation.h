...
namespace alice {
	namespace interaction {
		...
		/** @class alice::interaction::GrabTranslation alice/interaction/Manipulation/GrabTranslation.h
			* @brief Moves the selected object according to the wand's displacement
			*/
		class GrabTranslation : public alice::InteractionMethod {

		public:

			/** @brief Constructor, calls parent and stores the button number */
			GrabTranslation(int buttonNumber = 0) :
